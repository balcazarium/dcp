        ...
        <div class="container px-4">
            ...
            <div class="collapse navbar-collapse" id="mainNavMenu">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link active" id="nav-nosotros" href="index.html">Nosotros</a></li>
                ...
                <ul id="topbar-social-links" class="social-links-list">
                    <li><a href="#"><img src="assets/img/icons/Iconos_Redes_DCP_Facebook.svg" alt="facebook"></a></li>
                    <li><a href="#"><img src="assets/img/icons/Iconos_Redes_DCP_LinkedIn.svg" alt="linkedin"></a></li>
                    <li><a href="#"><img src="assets/img/icons/Iconos_Redes_DCP_Instagram.svg" alt="instagram"></a></li>
                    <li><a href="#"><img src="assets/img/icons/Iconos_Redes_DCP_YouTube.svg" alt="youtube"></a></li>
                </ul>
            </div>
        </div>
    </nav>
